...
export default function CollagePage() {
  ...
  const t = useTranslations('collageMakerPage');
  const tTools = useTranslations('tools.collageMaker');
  const locale = useLocale();

  return (
    <ToolsLayout>
      <BreadcrumbSchema items={getToolBreadcrumbs(tTools('name'), 'collage', locale)} />
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-20 right-1/4 w-80 h-80 bg-amber-300/20 dark:bg-amber-600/20 rounded-full blur-3xl" />
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-3 gap-8 max-w-lg mx-auto">
              ...
              <div className="text-center">
                ...
                <div className="text-gray-500 dark:text-gray-400 text-sm mt-1">{t('stats.imagesLabel')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">{t('stats.layouts')}</div>
                <div className="text-gray-500 dark:text-gray-400 text-sm mt-1">{t('stats.layoutsLabel')}</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {['step1', 'step2', 'step3', 'step4'].map((step, idx) => (
              <div key={step} className="text-center">
                <div className="w-12 h-12 bg-gradient-to-br from-orange-500 to-amber-500 rounded-full flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">
                  {idx + 1}
                </div>
      ...
      {/* Technology Section */}
      <section className="max-w-7xl mx-auto px-6 py-12">
        <div className="bg-gradient-to-br from-orange-100 to-amber-100 dark:from-orange-900/30 dark:to-amber-900/30 rounded-2xl border border-orange-300 dark:border-orange-700/50 p-8">
      ...
      {/* Related Tools */}
      <section className="max-w-7xl mx-auto px-6 py-12">
        <RelatedTools currentSlug="collage" />
      </section>

      {/* CTA Section */}
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="bg-gradient-to-r from-orange-100 to-amber-100 dark:from-orange-900/50 dark:to-amber-900/50 border border-orange-300 dark:border-orange-500/30 rounded-2xl p-8 md:p-12 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white">
            {t('cta.title')}
          </h2>
          ...
          {!session ? (
            <Link
              href="/auth/signin"
              className="inline-block px-8 py-4 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 text-white rounded-xl font-semibold text-lg transition shadow-lg shadow-orange-500/25"
            >
              {t('cta.getStarted')}
            </Link>
          ) : (
            <button
              ...
              className="px-8 py-4 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 text-white rounded-xl font-semibold text-lg transition shadow-lg shadow-orange-500/25"
            >
              {t('cta.startAction')}
            </button>
          )}
