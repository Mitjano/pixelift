...
const toolsData = [
  {
    ...
    cardClass: 'bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-gray-800 dark:to-gray-800/80 border-blue-200 dark:border-blue-500/40',
  ...
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-purple-50 to-pink-50 dark:from-gray-800 dark:to-gray-800/80 border-purple-200 dark:border-purple-500/40',
  ...
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-gray-800 dark:to-gray-800/80 border-purple-200 dark:border-indigo-500/40',
    iconBg: 'bg-gradient-to-br from-purple-500/20 to-indigo-500/20 dark:from-purple-500/30 dark:to-indigo-500/30',
    credits: '2 credits',
    aiModel: 'FLUX Fill',
  },
  {
    ...
    href: '/tools/colorize',
    color: 'from-purple-500 to-pink-500',
    cardClass: 'bg-gradient-to-br from-purple-50 to-pink-50 dark:from-gray-800 dark:to-gray-800/80 border-purple-200 dark:border-pink-500/40',
    iconBg: 'bg-gradient-to-br from-purple-500/20 to-pink-500/20 dark:from-purple-500/30 dark:to-pink-500/30',
    credits: '1 credit',
    aiModel: 'DeOldify AI',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-gray-800 dark:to-gray-800/80 border-cyan-200 dark:border-cyan-500/40',
    iconBg: 'bg-gradient-to-br from-cyan-500/20 to-blue-500/20 dark:from-cyan-500/30 dark:to-blue-500/30',
    credits: '1 credit',
    aiModel: 'Real-ESRGAN',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-orange-50 to-red-50 dark:from-gray-800 dark:to-gray-800/80 border-orange-200 dark:border-orange-500/40',
    iconBg: 'bg-gradient-to-br from-orange-500/20 to-red-500/20 dark:from-orange-500/30 dark:to-red-500/30',
    credits: '2 credits',
    aiModel: 'BRIA Eraser',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-green-50 to-emerald-50 dark:from-gray-800 dark:to-gray-800/80 border-green-200 dark:border-green-500/40',
    iconBg: 'bg-gradient-to-br from-green-500/20 to-emerald-500/20 dark:from-green-500/30 dark:to-emerald-500/30',
    credits: '2 credits',
    aiModel: 'DALL-E 2',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-pink-50 to-purple-50 dark:from-gray-800 dark:to-gray-800/80 border-pink-200 dark:border-pink-500/40',
    iconBg: 'bg-gradient-to-br from-pink-500/20 to-purple-500/20 dark:from-pink-500/30 dark:to-purple-500/30',
    credits: '3 credits',
    aiModel: 'BRIA AI',
  },
  {
  ...
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-amber-50 to-orange-50 dark:from-gray-800 dark:to-gray-800/80 border-amber-200 dark:border-amber-500/40',
    iconBg: 'bg-gradient-to-br from-amber-500/20 to-orange-500/20 dark:from-amber-500/30 dark:to-orange-500/30',
    credits: '3 credits',
    aiModel: 'FLUX Redux',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-violet-50 to-purple-50 dark:from-gray-800 dark:to-gray-800/80 border-violet-200 dark:border-violet-500/40',
    iconBg: 'bg-gradient-to-br from-violet-500/20 to-purple-500/20 dark:from-violet-500/30 dark:to-purple-500/30',
    credits: '2 credits',
    aiModel: 'FLUX Redux',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-teal-50 to-cyan-50 dark:from-gray-800 dark:to-gray-800/80 border-teal-200 dark:border-teal-500/40',
    iconBg: 'bg-gradient-to-br from-teal-500/20 to-cyan-500/20 dark:from-teal-500/30 dark:to-cyan-500/30',
    credits: '3 credits',
    aiModel: 'FLUX Depth',
  },
  {
    ...
    cardClass: 'bg-gradient-to-br from-rose-50 to-pink-50 dark:from-gray-800 dark:to-gray-800/80 border-rose-200 dark:border-rose-500/40',
    iconBg: 'bg-gradient-to-br from-rose-500/20 to-pink-500/20 dark:from-rose-500/30 dark:to-pink-500/30',
    credits: '3 credits',
    aiModel: 'FLUX Fill',
  },
];
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {tools.map((tool) => (
              <Link
                key={tool.id}
                href={tool.href}
                className={`group ${tool.cardClass} rounded-xl border p-6 hover:border-gray-400 dark:hover:border-gray-500 transition-all hover:scale-[1.02] hover:shadow-xl shadow-sm`}
              >
                <div className="flex items-start justify-between mb-4">
                  <div className={`w-14 h-14 rounded-xl ${tool.iconBg} flex items-center justify-center text-2xl border border-gray-200/50 dark:border-gray-600/50`}>
                    {tool.icon}
                  </div>
