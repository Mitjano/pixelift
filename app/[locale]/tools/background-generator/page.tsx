      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section className="relative overflow-hidden px-6 pt-8 pb-12">
          ...
          <div className="relative text-center">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-pink-600/20 border border-pink-500/30 rounded-full text-sm mb-6">
              ...
              <span className="text-pink-300">Powered by BRIA AI</span>
            </div>
            ...
            <p className="text-gray-400 text-lg max-w-3xl mx-auto mb-8">
              Generate stunning AI backgrounds for your product photos and portraits.
            ...
            <div className="flex flex-wrap justify-center gap-8 mb-8">
              <div className="text-center">
                <div className="text-2xl font-bold text-pink-400">Custom</div>
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-pink-400">3 Credits</div>
                <div className="text-sm text-gray-500">Per Generation</div>
              </div>
            </div>

            {credits !== undefined && session && (
              <div className="inline-flex items-center gap-2 bg-pink-900/30 border border-pink-800 rounded-full px-4 py-2">
        ...
        <section className="px-6 mb-16">
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-pink-900/20 to-purple-900/20 rounded-xl border border-pink-700/30 p-6">
              <div className="w-12 h-12 bg-pink-500/20 rounded-lg flex items-center justify-center mb-4">
                <span className="text-2xl">🎨</span>
              </div>
              <h3 className="text-lg font-semibold mb-2">Describe Any Background</h3>
              <p className="text-sm text-gray-400">
                Use natural language to describe the background you envision - AI makes it real.
              </p>
            </div>
            <div className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 rounded-xl border border-purple-700/30 p-6">
              <div className="w-12 h-12 bg-purple-500/20 rounded-lg flex items-center justify-center mb-4">
                <span className="text-2xl">🎯</span>
              </div>
              <h3 className="text-lg font-semibold mb-2">Perfect Integration</h3>
              <p className="text-sm text-gray-400">
                AI blends your subject naturally with the generated background seamlessly.
              </p>
            </div>
            <div className="bg-gradient-to-br from-pink-900/20 to-purple-900/20 rounded-xl border border-pink-700/30 p-6">
              <div className="w-12 h-12 bg-pink-500/20 rounded-lg flex items-center justify-center mb-4">
              ...
              <p className="text-sm text-gray-400">
                Choose from studio, nature, urban, and other preset backgrounds for instant results.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="px-6 mb-16">
          <div className="bg-gray-800/30 rounded-2xl border border-gray-700 p-8">
            <h2 className="text-2xl font-bold mb-8 text-center">How Background Generation Works</h2>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-pink-500/20 to-purple-500/20 flex items-center justify-center mx-auto mb-4 border border-pink-500/30">
                  <span className="text-pink-400 font-bold text-2xl">1</span>
                </div>
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-400">
                  Choose a preset or describe your desired background in words
                </p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-pink-500/20 to-purple-500/20 flex items-center justify-center mx-auto mb-4 border border-pink-500/30">
        ...
        {/* Workflow Tip */}
        <section className="px-6 mb-16">
          <div className="bg-gradient-to-br from-pink-900/20 to-purple-900/20 rounded-xl border border-pink-700/50 p-6">
            ...
            <div className="flex flex-wrap gap-2 items-center">
              <Link href="/tools/remove-background" className="px-3 py-1 bg-blue-500/20 border border-blue-500/50 rounded-full text-sm hover:bg-blue-500/30 transition">
                1. Remove Background
              </Link>
              ...
              <span className="text-gray-500">→</span>
              <Link href="/tools/upscaler" className="px-3 py-1 bg-green-500/20 border border-green-500/50 rounded-full text-sm hover:bg-green-500/30 transition">
                3. Upscale Result
              </Link>
            </div>
          </div>
        ...
        <section className="px-6 mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gray-800/30 rounded-xl border border-gray-700 p-6 hover:border-pink-500/50 transition">
        ...
        <section className="px-6 mb-16">
          <div className="bg-gray-800/30 rounded-2xl border border-gray-700 p-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h4 className="font-semibold text-pink-400 mb-3">Image Preparation</h4>
                <ul className="space-y-2 text-sm text-gray-400">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">✓</span>
                    Remove background first using our tool
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">✓</span>
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-green-400 mt-0.5">✓</span>
                    Clean cutouts with smooth edges work best
                  </li>
                </ul>
              </div>
              <div>
                <h4 className="font-semibold text-purple-400 mb-3">Prompt Tips</h4>
                <ul className="space-y-2 text-sm text-gray-400">
                  <li className="flex items-start gap-2">
                    <span className="text-pink-400 mt-0.5">★</span>
                    Be specific about lighting (soft, dramatic, natural)
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-pink-400 mt-0.5">★</span>
                    Describe the style (professional, artistic, minimal)
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-pink-400 mt-0.5">★</span>
                    Include color preferences in your prompt
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-pink-400 mt-0.5">★</span>
                    Use "refine prompt" for AI-enhanced descriptions
                  </li>
                </ul>
              </div>
            </div>
        ...
        <section className="px-6 pb-12">
          <div className="bg-gradient-to-r from-pink-900/30 to-purple-900/30 rounded-2xl border border-pink-700/30 p-8 text-center">
            <h2 className="text-2xl font-bold mb-4">Ready to Create Stunning Backgrounds?</h2>
            <p className="text-gray-400 mb-6 max-w-2xl mx-auto">
              Transform your images with AI-generated backgrounds that perfectly match your vision.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                href="/pricing"
                className="px-6 py-3 bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 rounded-lg font-semibold transition"
              >
                Get Credits
              </Link>
              <Link
