        ...
        <section className="relative overflow-hidden px-6 pt-8 pb-12">
          ...
          <div className="relative text-center">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-pink-600/20 border border-pink-500/30 rounded-full text-sm mb-6">
              ...
              <span className="text-pink-300">{t('badge')}</span>
            </div>
            ...
            <div className="flex flex-wrap justify-center gap-8 mb-8">
              <div className="text-center">
                <div className="text-2xl font-bold text-pink-400">{t('stats.custom')}</div>
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-pink-400">{t('stats.credits')}</div>
        ...
        <section className="px-6 mb-16">
          <div className="bg-gray-800/30 rounded-2xl border border-gray-700 p-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h4 className="font-semibold text-pink-400 mb-3">{t('tips.imagePrep.title')}</h4>
              ...
              <div>
                <h4 className="font-semibold text-purple-400 mb-3">{t('tips.prompts.title')}</h4>
                <ul className="space-y-2 text-sm text-gray-400">
                  <li className="flex items-start gap-2">
