...
export default function ImageFiltersPage() {
  ...
  const t = useTranslations('imageFiltersPage');
  const tTools = useTranslations('tools.imageFilters');
  const locale = useLocale();

  return (
    <ToolsLayout>
      <BreadcrumbSchema items={getToolBreadcrumbs(tTools('name'), 'image-filters', locale)} />
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-20 right-1/4 w-80 h-80 bg-rose-300/20 dark:bg-rose-600/20 rounded-full blur-3xl" />
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16 md:py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
              ...
              <span className="bg-gradient-to-r from-pink-500 via-rose-500 to-pink-500 dark:from-pink-400 dark:via-rose-400 dark:to-pink-400 bg-clip-text text-transparent">
                {t('titleHighlight')}
              </span>
            </h1>
            ...
            <div className="grid grid-cols-3 gap-8 max-w-lg mx-auto">
              ...
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">{t('stats.sliders')}</div>
                <div className="text-gray-500 dark:text-gray-400 text-sm mt-1">{t('stats.slidersLabel')}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              ...
              <span className="bg-gradient-to-r from-pink-500 to-rose-500 dark:from-pink-400 dark:to-rose-400 bg-clip-text text-transparent">
      ...
      {/* Technology Section */}
      <section className="max-w-7xl mx-auto px-6 py-12">
        <div className="bg-gradient-to-br from-pink-100 to-rose-100 dark:from-pink-900/30 dark:to-rose-900/30 rounded-2xl border border-pink-300 dark:border-pink-700/50 p-8">
      ...
      {/* CTA Section */}
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="bg-gradient-to-r from-pink-100 to-rose-100 dark:from-pink-900/50 dark:to-rose-900/50 border border-pink-300 dark:border-pink-500/30 rounded-2xl p-8 md:p-12 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white">
            {t('cta.title')}
          </h2>
          ...
          {!session ? (
            <Link
              href="/auth/signin"
              className="inline-block px-8 py-4 bg-gradient-to-r from-pink-600 to-rose-600 hover:from-pink-700 hover:to-rose-700 text-white rounded-xl font-semibold text-lg transition shadow-lg shadow-pink-500/25"
            >
              {t('cta.getStarted')}
            </Link>
          ) : (
            <button
              ...
              className="px-8 py-4 bg-gradient-to-r from-pink-600 to-rose-600 hover:from-pink-700 hover:to-rose-700 text-white rounded-xl font-semibold text-lg transition shadow-lg shadow-pink-500/25"
            >
              {t('cta.startAction')}
            </button>
          )}
