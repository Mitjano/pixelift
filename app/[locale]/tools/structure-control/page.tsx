...
export default function StructureControlPage() {
  ...
  const t = useTranslations('structureControlPage');
  const tTools = useTranslations('tools.structureControl');
  const locale = useLocale();

  return (
    <ToolsLayout>
      <BreadcrumbSchema items={getToolBreadcrumbs(tTools('name'), 'structure-control', locale)} />
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-20 right-1/4 w-80 h-80 bg-orange-300/20 dark:bg-orange-600/20 rounded-full blur-3xl" />
      ...
      {/* Technology Section */}
      <section className="max-w-7xl mx-auto px-6 py-12">
        <div className="bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/30 dark:to-orange-900/30 rounded-2xl border border-amber-300 dark:border-amber-700/50 p-8">
      ...
      {/* Related Tools */}
      <section className="max-w-7xl mx-auto px-6 py-12">
        <RelatedTools currentSlug="structure-control" />
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="bg-gradient-to-r from-amber-100 to-orange-100 dark:from-amber-900/50 dark:to-orange-900/50 border border-amber-300 dark:border-amber-500/30 rounded-2xl p-8 md:p-12 text-center">
          ...
          {!session ? (
            <Link
              href="/auth/signin"
              className="inline-block px-8 py-4 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white rounded-xl font-semibold text-lg transition shadow-lg shadow-amber-500/25"
            >
              {t('cta.getStarted')}
            </Link>
          ) : (
            <button
              ...
              className="px-8 py-4 bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700 text-white rounded-xl font-semibold text-lg transition shadow-lg shadow-amber-500/25"
            >
              {t('cta.startAction')}
            </button>
          )}
