  ...
  return (
    <ToolsLayout>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-20 right-1/4 w-80 h-80 bg-orange-600/20 rounded-full blur-3xl" />
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16 md:py-20">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-amber-600/20 border border-amber-500/30 rounded-full text-sm mb-6">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-amber-400 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-amber-500"></span>
              </span>
              <span className="text-amber-300">Powered by FLUX Depth & Canny Pro</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-8 max-w-lg mx-auto">
              <div className="text-center">
                ...
                <div className="text-gray-400 text-sm mt-1">Control Modes</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-white">~40s</div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-amber-500/20 to-orange-500/20 backdrop-blur-sm border border-gray-700 rounded-2xl p-6">
            <div className="text-4xl mb-4">🔲</div>
            <h3 className="text-xl font-semibold text-white mb-2">Depth Control</h3>
            <p className="text-gray-400 mb-4">Preserves the 3D structure, depth, and perspective of your image. Perfect for:</p>
          ...
          <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-sm border border-gray-700 rounded-2xl p-6">
            <div className="text-4xl mb-4">📐</div>
            <h3 className="text-xl font-semibold text-white mb-2">Edge Control</h3>
            <p className="text-gray-400 mb-4">Preserves the shapes, outlines, and contours of your image. Perfect for:</p>
            <ul className="text-sm text-gray-500 space-y-1">
      ...
      <section className="bg-gray-900/50 border-y border-gray-800 py-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-amber-500/20 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl">1</div>
              <h3 className="font-semibold mb-2">Upload Reference</h3>
              <p className="text-sm text-gray-400">Upload an image with the structure/composition you want to preserve</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-orange-500/20 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl">2</div>
              <h3 className="font-semibold mb-2">Choose Mode & Prompt</h3>
              <p className="text-sm text-gray-400">Select Depth or Edge control and describe what you want to generate</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-red-500/20 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl">3</div>
              <h3 className="font-semibold mb-2">Generate</h3>
              <p className="text-sm text-gray-400">AI creates a new image following your reference structure</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="bg-gradient-to-r from-amber-900/50 to-orange-900/50 border border-amber-500/30 rounded-2xl p-8 md:p-12 text-center">
