    ...
    <ToolsLayout>
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16 md:py-20">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-600/20 border border-cyan-500/30 rounded-full text-sm mb-6">
              ...
              <span className="text-cyan-300">Powered by FLUX Fill Pro AI</span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-8 max-w-lg mx-auto">
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-white">Pro</div>
                <div className="text-gray-400 text-sm mt-1">Quality</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-white">~45s</div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-cyan-500/20 to-blue-500/20 backdrop-blur-sm border border-gray-700 rounded-2xl p-6">
            <div className="text-4xl mb-4">🖌️</div>
            <h3 className="text-xl font-semibold text-white mb-2">Smart Fill</h3>
            <p className="text-gray-400">Paint over unwanted objects and let AI seamlessly fill the area with matching content.</p>
          </div>
          <div className="bg-gradient-to-br from-blue-500/20 to-indigo-500/20 backdrop-blur-sm border border-gray-700 rounded-2xl p-6">
            <div className="text-4xl mb-4">✨</div>
            <h3 className="text-xl font-semibold text-white mb-2">Prompt-Based</h3>
            <p className="text-gray-400">Describe what you want to appear in the painted area for precise, creative results.</p>
          </div>
          <div className="bg-gradient-to-br from-indigo-500/20 to-cyan-500/20 backdrop-blur-sm border border-gray-700 rounded-2xl p-6">
            <div className="text-4xl mb-4">🔧</div>
            <h3 className="text-xl font-semibold text-white mb-2">Adjustable Brush</h3>
            <p className="text-gray-400">Variable brush size for precise masking - from fine details to large areas.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-gray-800/50 rounded-xl p-5 text-center">
              ...
              <h3 className="font-semibold mb-2">Remove Objects</h3>
              <p className="text-sm text-gray-400">Remove unwanted elements from photos</p>
            </div>
            <div className="bg-gray-800/50 rounded-xl p-5 text-center">
              <div className="text-3xl mb-3">🔄</div>
              <h3 className="font-semibold mb-2">Replace Content</h3>
              <p className="text-sm text-gray-400">Swap elements with something new</p>
            </div>
            <div className="bg-gray-800/50 rounded-xl p-5 text-center">
              <div className="text-3xl mb-3">🖼️</div>
              <h3 className="font-semibold mb-2">Extend Images</h3>
              <p className="text-sm text-gray-400">Add content beyond original borders</p>
            </div>
            <div className="bg-gray-800/50 rounded-xl p-5 text-center">
              <div className="text-3xl mb-3">🔧</div>
              <h3 className="font-semibold mb-2">Fix Imperfections</h3>
              <p className="text-sm text-gray-400">Repair damaged or missing parts</p>
            </div>
          </div>
        </div>
      </section>
