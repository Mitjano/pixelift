...
export default function ReimaginePage() {
  ...
  const t = useTranslations('reimaginePage');
  const tTools = useTranslations('tools.reimagine');
  const locale = useLocale();

  return (
    <ToolsLayout>
      <BreadcrumbSchema items={getToolBreadcrumbs(tTools('name'), 'reimagine', locale)} />
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-emerald-300/30 dark:bg-emerald-600/20 rounded-full blur-3xl" />
        <div className="absolute top-20 right-1/4 w-80 h-80 bg-teal-300/20 dark:bg-teal-600/20 rounded-full blur-3xl" />
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16 md:py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-3 gap-8 max-w-lg mx-auto">
              ...
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">{t('stats.variations')}</div>
                <div className="text-gray-500 dark:text-gray-400 text-sm mt-1">{t('stats.variationsLabel')}</div>
              </div>
              <div className="text-center">
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { key: 'creative', gradient: 'from-emerald-100 dark:from-emerald-500/20 to-teal-100 dark:to-teal-500/20' },
            { key: 'subtle', gradient: 'from-teal-100 dark:from-teal-500/20 to-cyan-100 dark:to-cyan-500/20' },
            { key: 'dramatic', gradient: 'from-cyan-100 dark:from-cyan-500/20 to-emerald-100 dark:to-emerald-500/20' },
          ].map((option) => (
            <div
              key={option.key}
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { icon: '✨', key: 'variations', gradient: 'from-emerald-100 dark:from-emerald-500/20 to-teal-100 dark:to-teal-500/20' },
            { icon: '🎯', key: 'preservation', gradient: 'from-teal-100 dark:from-teal-500/20 to-cyan-100 dark:to-cyan-500/20' },
            { icon: '🎨', key: 'customization', gradient: 'from-cyan-100 dark:from-cyan-500/20 to-emerald-100 dark:to-emerald-500/20' },
          ].map((feature) => (
            <div
              key={feature.key}
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {['step1', 'step2', 'step3', 'step4'].map((step, idx) => (
              <div key={step} className="text-center">
                <div className="w-12 h-12 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-full flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">
                  {idx + 1}
                </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {['creative', 'marketing', 'social', 'design'].map((useCase) => (
            <div
              key={useCase}
              className="bg-gray-50 dark:bg-gray-800/30 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:border-emerald-500/50 transition"
            >
      ...
      {/* Technology Section */}
      <section className="max-w-7xl mx-auto px-6 py-12">
        <div className="bg-gradient-to-br from-emerald-100 to-teal-100 dark:from-emerald-900/30 dark:to-teal-900/30 rounded-2xl border border-emerald-300 dark:border-emerald-700/50 p-8">
      ...
      {/* Related Tools */}
      <section className="max-w-7xl mx-auto px-6 py-12">
        <RelatedTools currentSlug="reimagine" />
      </section>

      {/* CTA Section */}
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="bg-gradient-to-r from-emerald-100 to-teal-100 dark:from-emerald-900/50 dark:to-teal-900/50 border border-emerald-300 dark:border-emerald-500/30 rounded-2xl p-8 md:p-12 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white">
            {t('cta.title')}
          </h2>
          ...
          {!session ? (
            <Link
              href="/auth/signin"
              className="inline-block px-8 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white rounded-xl font-semibold text-lg transition shadow-lg shadow-emerald-500/25"
            >
              {t('cta.getStarted')}
            </Link>
          ) : (
            <button
              ...
              className="px-8 py-4 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white rounded-xl font-semibold text-lg transition shadow-lg shadow-emerald-500/25"
            >
              {t('cta.startAction')}
            </button>
          )}
