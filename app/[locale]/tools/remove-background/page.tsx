    ...
    <ToolsLayout>
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-3 gap-8 max-w-lg mx-auto">
              <div className="text-center">
                ...
                <div className="text-gray-600 dark:text-gray-400 text-sm mt-1">{t('stats.processing')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">256</div>
                <div className="text-gray-600 dark:text-gray-400 text-sm mt-1">{t('stats.alphaLevels')}</div>
              </div>
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white">1</div>
                <div className="text-gray-600 dark:text-gray-400 text-sm mt-1">{t('stats.creditPerImage')}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              <span className="text-gray-900 dark:text-white">{t('howItWorks.titlePrefix')}</span>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="text-xl font-semibold mb-3 text-blue-600 dark:text-blue-400">{t('howItWorks.technology.title')}</h3>
            ...
            <div>
              ...
              <div className="space-y-3 text-gray-600 dark:text-gray-400">
                <div className="bg-white dark:bg-gray-800/50 rounded-lg p-3">
                  <strong className="text-gray-900 dark:text-white">🛍️ {t('howItWorks.perfectFor.ecommerce')}</strong> {t('howItWorks.perfectFor.ecommerceDesc')}
                </div>
                <div className="bg-white dark:bg-gray-800/50 rounded-lg p-3">
                  <strong className="text-gray-900 dark:text-white">📱 {t('howItWorks.perfectFor.social')}</strong> {t('howItWorks.perfectFor.socialDesc')}
                </div>
                <div className="bg-white dark:bg-gray-800/50 rounded-lg p-3">
                  <strong className="text-gray-900 dark:text-white">🎨 {t('howItWorks.perfectFor.design')}</strong> {t('howItWorks.perfectFor.designDesc')}
                </div>
                <div className="bg-white dark:bg-gray-800/50 rounded-lg p-3">
                  <strong className="text-gray-900 dark:text-white">💼 {t('howItWorks.perfectFor.professional')}</strong> {t('howItWorks.perfectFor.professionalDesc')}
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={idx} className="bg-gray-50 dark:bg-gray-800/30 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:border-blue-500/50 transition">
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-br from-blue-100 dark:from-blue-900/20 to-cyan-100 dark:to-cyan-900/20 rounded-xl border border-blue-300 dark:border-blue-700/50 p-6">
            <h3 className="text-xl font-semibold mb-4 flex items-center gap-2">
              <span>🎯</span> {t('downloadOptions.title')}
            </h3>
            <div className="space-y-3 text-gray-700 dark:text-gray-300">
              <div>
                <strong className="text-gray-900 dark:text-white">{t('downloadOptions.low')}</strong> {t('downloadOptions.lowDesc')}
              </div>
              <div>
                <strong className="text-gray-900 dark:text-white">{t('downloadOptions.medium')}</strong> {t('downloadOptions.mediumDesc')}
              </div>
              <div>
                <strong className="text-gray-900 dark:text-white">{t('downloadOptions.high')}</strong> {t('downloadOptions.highDesc')}
              </div>
              <div>
                <strong className="text-gray-900 dark:text-white">{t('downloadOptions.original')}</strong> {t('downloadOptions.originalDesc')}
              </div>
            </div>
          </div>

          <div className="bg-gradient-to-br from-purple-100 dark:from-purple-900/20 to-pink-100 dark:to-pink-900/20 rounded-xl border border-purple-300 dark:border-purple-700/50 p-6">
            <h3 className="text-xl font-semibold mb-4 flex items-center gap-2">
              <span>📋</span> {t('formatQuality.title')}
            </h3>
            <div className="space-y-3 text-gray-700 dark:text-gray-300">
              <div>
                <strong className="text-gray-900 dark:text-white">{t('formatQuality.png')}</strong> {t('formatQuality.pngDesc')}
              </div>
              <div>
                <strong className="text-gray-900 dark:text-white">{t('formatQuality.jpg')}</strong> {t('formatQuality.jpgDesc')}
              </div>
              <div>
                <strong className="text-gray-900 dark:text-white">{t('formatQuality.processingTime')}</strong> {t('formatQuality.processingTimeDesc')}
              </div>
              <div>
                <strong className="text-gray-900 dark:text-white">{t('formatQuality.creditCost')}</strong> {t('formatQuality.creditCostDesc')}
              </div>
            </div>
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="bg-gradient-to-r from-blue-100 to-cyan-100 dark:from-blue-900/50 dark:to-cyan-900/50 border border-blue-300 dark:border-blue-500/30 rounded-2xl p-8 md:p-12 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white">
            {t('cta.title')}
          </h2>
