...
export default function LogoMakerPage() {
  ...
  const t = useTranslations('logoMakerPage');
  const tTools = useTranslations('tools.logoMaker');
  const locale = useLocale();

  return (
    <ToolsLayout>
      <BreadcrumbSchema items={getToolBreadcrumbs(tTools('name'), 'logo-maker', locale)} />
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute top-20 right-1/4 w-80 h-80 bg-violet-300/20 dark:bg-violet-600/20 rounded-full blur-3xl" />
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-16 md:py-20">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-100 dark:bg-indigo-600/20 border border-indigo-300 dark:border-indigo-500/30 rounded-full text-sm mb-6">
              ...
              <span className="text-indigo-600 dark:text-indigo-300">{t('badge')}</span>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { key: 'minimalist', gradient: 'from-gray-100 dark:from-gray-500/20 to-slate-100 dark:to-slate-500/20' },
            { key: 'vintage', gradient: 'from-amber-100 dark:from-amber-500/20 to-orange-100 dark:to-orange-500/20' },
            { key: 'modern', gradient: 'from-indigo-100 dark:from-indigo-500/20 to-violet-100 dark:to-violet-500/20' },
          ].map((option) => (
            <div
              key={option.key}
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            { icon: '🎨', key: 'multipleStyles', gradient: 'from-indigo-100 dark:from-indigo-500/20 to-violet-100 dark:to-violet-500/20' },
            { icon: '🤖', key: 'aiPowered', gradient: 'from-violet-100 dark:from-violet-500/20 to-purple-100 dark:to-purple-500/20' },
            { icon: '🎯', key: 'customization', gradient: 'from-purple-100 dark:from-purple-500/20 to-indigo-100 dark:to-indigo-500/20' },
          ].map((feature) => (
            <div
              key={feature.key}
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {['step1', 'step2', 'step3', 'step4'].map((step, idx) => (
              <div key={step} className="text-center">
                <div className="w-12 h-12 bg-gradient-to-br from-indigo-500 to-violet-500 rounded-full flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">
                  {idx + 1}
                </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {['startup', 'smallBusiness', 'content', 'projects'].map((useCase) => (
            <div
              key={useCase}
              className="bg-gray-50 dark:bg-gray-800/30 rounded-xl border border-gray-200 dark:border-gray-700 p-6 hover:border-indigo-500/50 transition"
            >
      ...
      {/* Technology Section */}
      <section className="max-w-7xl mx-auto px-6 py-12">
        <div className="bg-gradient-to-br from-indigo-100 to-violet-100 dark:from-indigo-900/30 dark:to-violet-900/30 rounded-2xl border border-indigo-300 dark:border-indigo-700/50 p-8">
      ...
      {/* Related Tools */}
      <section className="max-w-7xl mx-auto px-6 py-12">
        <RelatedTools currentSlug="logo-maker" />
      </section>

      {/* CTA Section */}
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="bg-gradient-to-r from-indigo-100 to-violet-100 dark:from-indigo-900/50 dark:to-violet-900/50 border border-indigo-300 dark:border-indigo-500/30 rounded-2xl p-8 md:p-12 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white">
            {t('cta.title')}
          </h2>
          ...
          {!session ? (
            <Link
              href="/auth/signin"
              className="inline-block px-8 py-4 bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 text-white rounded-xl font-semibold text-lg transition shadow-lg shadow-indigo-500/25"
            >
              {t('cta.getStarted')}
            </Link>
          ) : (
            <button
              ...
              className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 text-white rounded-xl font-semibold text-lg transition shadow-lg shadow-indigo-500/25"
            >
              {t('cta.startAction')}
            </button>
          )}
