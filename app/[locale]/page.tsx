    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-100 to-white dark:from-gray-900 dark:to-black text-gray-900 dark:text-white">
      ...
      <section className="relative container mx-auto px-4 py-20 md:py-28 text-center">
        ...
        <div className="relative z-10">
          ...
          {/* Quick Tool Access */}
          <div className="flex flex-wrap justify-center gap-3 mb-10 w-full max-w-md sm:max-w-none mx-auto">
            <Link
              href="/tools/upscaler"
              className="flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl font-semibold text-sm text-white shadow-lg hover:shadow-xl hover:shadow-green-500/30 transition-all duration-300 hover:scale-105 min-w-[140px] sm:min-w-0"
            >
            ...
            <Link
              ...
              className="flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl font-semibold text-sm text-white shadow-lg hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-300 hover:scale-105 min-w-[140px] sm:min-w-0"
            >
              <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              href="/tools/colorize"
              className="relative flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-violet-500 to-purple-600 rounded-xl font-semibold text-sm text-white shadow-lg hover:shadow-xl hover:shadow-purple-500/30 transition-all duration-300 hover:scale-105 min-w-[140px] sm:min-w-0"
            >
              <span className="absolute -top-2 -right-2 px-1.5 py-0.5 text-[10px] font-bold bg-yellow-500 text-black rounded-full">NEW</span>
              <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              ...
              className="relative flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-orange-500 to-red-600 rounded-xl font-semibold text-sm text-white shadow-lg hover:shadow-xl hover:shadow-orange-500/30 transition-all duration-300 hover:scale-105 min-w-[140px] sm:min-w-0"
            >
              <span className="absolute -top-2 -right-2 px-1.5 py-0.5 text-[10px] font-bold bg-yellow-500 text-black rounded-full">NEW</span>
              <svg className="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
