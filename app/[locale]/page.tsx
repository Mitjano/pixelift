    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-100 to-white dark:from-gray-900 dark:to-black text-gray-900 dark:text-white">
      ...
      <section className="relative container mx-auto px-4 py-20 md:py-28 text-center overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          {/* Quick Tool Access */}
          <div className="grid grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:justify-center sm:gap-3 mb-10 px-4 sm:px-2 max-w-sm sm:max-w-none mx-auto">
            <Link
              href="/tools/upscaler"
              className="group flex items-center justify-center gap-1.5 sm:gap-2 px-3 py-2.5 sm:px-5 sm:py-3 bg-gradient-to-r from-green-500 to-emerald-600 rounded-lg sm:rounded-xl font-semibold text-xs sm:text-base hover:shadow-xl hover:shadow-green-500/30 transition-all duration-300 sm:hover:scale-105"
            >
            ...
            <Link
              ...
              className="group flex items-center justify-center gap-1.5 sm:gap-2 px-3 py-2.5 sm:px-5 sm:py-3 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg sm:rounded-xl font-semibold text-xs sm:text-base hover:shadow-xl hover:shadow-blue-500/30 transition-all duration-300 sm:hover:scale-105"
            >
              <svg className="hidden sm:block w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              href="/tools/colorize"
              className="group relative flex items-center justify-center gap-1.5 sm:gap-2 px-3 py-2.5 sm:px-5 sm:py-3 bg-gradient-to-r from-violet-500 to-purple-600 rounded-lg sm:rounded-xl font-semibold text-xs sm:text-base hover:shadow-xl hover:shadow-purple-500/30 transition-all duration-300 sm:hover:scale-105"
            >
              <span className="absolute -top-1.5 -right-1 px-1 py-0.5 text-[8px] sm:text-[10px] font-bold bg-yellow-500 text-black rounded-full leading-none">NEW</span>
              <svg className="hidden sm:block w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              ...
              className="group relative flex items-center justify-center gap-1.5 sm:gap-2 px-3 py-2.5 sm:px-5 sm:py-3 bg-gradient-to-r from-orange-500 to-red-600 rounded-lg sm:rounded-xl font-semibold text-xs sm:text-base hover:shadow-xl hover:shadow-orange-500/30 transition-all duration-300 sm:hover:scale-105"
            >
              <span className="absolute -top-1.5 -right-1 px-1 py-0.5 text-[8px] sm:text-[10px] font-bold bg-yellow-500 text-black rounded-full leading-none">NEW</span>
              <svg className="hidden sm:block w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
