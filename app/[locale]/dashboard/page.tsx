...
const allTools = [
  ...
  { nameKey: 'inpainting', href: '/tools/inpainting', icon: '🖌️', color: 'text-cyan-400', credits: '3', badge: 'NEW' },
  ...
  { nameKey: 'structureControl', href: '/tools/structure-control', icon: '🏗️', color: 'text-amber-400', credits: '3', badge: 'NEW' },
];
