    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <header className="bg-gray-800 border-b border-gray-700 py-4">
        <div className="container mx-auto px-4 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <span className="text-purple-400 font-medium">API Documentation</span>
          </div>
          <div className="flex items-center space-x-4">
            <a
              href="/api/openapi"
      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <section className="mb-12">
          <h1 className="text-4xl font-bold text-white mb-4">Pixelift API</h1>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8">
            <div className="bg-gray-800 p-4 rounded-lg border border-gray-700">
              ...
              <code className="text-purple-400 text-sm">https://pixelift.pl/api</code>
            </div>
            <div className="bg-gray-800 p-4 rounded-lg border border-gray-700">
              <h3 className="text-white font-semibold mb-2">Version</h3>
              <code className="text-purple-400 text-sm">v1.0.0</code>
            </div>
            <div className="bg-gray-800 p-4 rounded-lg border border-gray-700">
              <h3 className="text-white font-semibold mb-2">Format</h3>
              <code className="text-purple-400 text-sm">JSON / multipart</code>
            </div>
          </div>
        </section>
...
{`curl -X POST https://pixelift.pl/api/upscale \\
  ...
  -F "scale=2"`}
            ...
            <p className="text-gray-400 mt-4 text-sm">
              Generate API keys in your <a href="/dashboard/api-keys" className="text-purple-400 hover:underline">dashboard</a>.
            </p>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700 mb-4">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <code className="text-white">/api/upscale</code>
            </div>
            <p className="text-gray-300 mb-4">Upscale an image using AI (Real-ESRGAN)</p>
          ...
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700 mb-4">
            <div className="flex items-center space-x-3 mb-4">
              <span className="bg-green-600 text-white text-xs font-bold px-2 py-1 rounded">POST</span>
              <code className="text-white">/api/enhance</code>
            </div>
            <p className="text-gray-300">Enhance image quality without changing resolution</p>
          </div>
          ...
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700 mb-4">
            <div className="flex items-center space-x-3 mb-4">
              <span className="bg-green-600 text-white text-xs font-bold px-2 py-1 rounded">POST</span>
              <code className="text-white">/api/background-remove</code>
            </div>
            <p className="text-gray-300">Remove background from an image</p>
          </div>
          ...
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700 mb-4">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <code className="text-white">/api/history</code>
            </div>
            <p className="text-gray-300">Get your image processing history</p>
          </div>
          ...
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700 mb-4">
            <div className="flex items-center space-x-3 mb-4">
              <span className="bg-green-600 text-white text-xs font-bold px-2 py-1 rounded">POST</span>
              <code className="text-white">/api/stripe/checkout</code>
            </div>
            <p className="text-gray-300">Create a Stripe checkout session for credits</p>
          </div>
        </section>
          ...
          <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
            <table className="w-full text-sm">
              ...
              <tbody className="text-gray-300">
                ...
                <tr className="border-b border-gray-700">
                  <td className="py-2"><code className="text-red-400">402</code></td>
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            {/* JavaScript */}
            <div className="bg-gray-800 p-6 rounded-lg border border-gray-700">
              <h3 className="text-white font-semibold mb-3">JavaScript / Node.js</h3>
              <pre className="bg-gray-900 p-4 rounded-lg overflow-x-auto">
                <code className="text-green-400">
...
{`curl -X POST https://pixelift.pl/api/upscale \\
  ...
  -F "face_enhance=true"`}
        ...
        <footer className="text-center text-gray-500 py-8 border-t border-gray-700">
          <p>Need help? Contact <a href="mailto:support@pixelift.pl" className="text-purple-400 hover:underline">support@pixelift.pl</a></p>
        </footer>
      </main>
    </div>
  );
