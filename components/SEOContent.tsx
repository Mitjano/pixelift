        ...
        <div className="prose prose-invert max-w-none">
          ...
          <div className="mt-8 bg-gray-800/50 border border-gray-700 rounded-xl p-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                <h4 className="font-semibold text-green-400 mb-2">{t('useCases.photography.title')}</h4>
                <p className="text-sm leading-relaxed">
                  {t('useCases.photography.description')}
                </p>
              </div>
              <div>
                <h4 className="font-semibold text-blue-400 mb-2">{t('useCases.ecommerce.title')}</h4>
                <p className="text-sm leading-relaxed">
                  {t('useCases.ecommerce.description')}
                </p>
              </div>
              <div>
                <h4 className="font-semibold text-purple-400 mb-2">{t('useCases.digitalArt.title')}</h4>
                <p className="text-sm leading-relaxed">
              ...
              <ol className="space-y-3">
                {[1, 2, 3, 4].map((step) => (
                  <li key={step} className="flex items-start gap-3">
                    ...
                    <div>
                      <strong className="text-white">{t(`howItWorks.steps.s${step}.title`)}</strong> {t(`howItWorks.steps.s${step}.description`)}
                    </div>
                  </li>
                ))}
              </ol>
          ...
          <div className="mt-8 grid md:grid-cols-4 gap-4 text-center text-sm">
            <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700">
              ...
              <div className="text-gray-400">{t('stats.upscalingOptions')}</div>
            </div>
            <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700">
              <div className="font-bold text-2xl text-blue-400 mb-1">10-20s</div>
              <div className="text-gray-400">{t('stats.averageProcessing')}</div>
            </div>
            <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700">
              <div className="font-bold text-2xl text-purple-400 mb-1">10M+</div>
              <div className="text-gray-400">{t('stats.imagesEnhanced')}</div>
            </div>
            <div className="bg-gray-800/30 rounded-lg p-4 border border-gray-700">
              <div className="font-bold text-2xl text-yellow-400 mb-1">4.9/5</div>
              <div className="text-gray-400">{t('stats.userRating')}</div>
            </div>
          </div>
        </div>
      </div>
