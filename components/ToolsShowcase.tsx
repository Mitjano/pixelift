      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
        {tools.map((tool) => (
          <Link
            key={tool.href}
            href={tool.href}
            className="group relative bg-white dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-900 backdrop-blur-sm rounded-2xl border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 p-6 transition-all duration-300 hover:scale-[1.02] shadow-sm hover:shadow-xl overflow-hidden"
          >
            ...
            <div className="relative">
              ...
              <div className="flex items-center justify-between">
                <span className="text-xs font-medium text-gray-500 dark:text-gray-300 bg-gray-200 dark:bg-gray-700 px-3 py-1 rounded-full">
